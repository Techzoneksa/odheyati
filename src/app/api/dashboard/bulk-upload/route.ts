...
function mimeFromBuffer(buffer: Buffer): string | null {
  ...
  if (buffer[0] === 0x00 && buffer[1] === 0x00 && buffer[2] === 0x00 && (buffer[3] === 0x18 || buffer[3] === 0x1C || buffer[3] === 0x20)) {
    if (buffer[4] === 0x66 && buffer[5] === 0x74 && buffer[6] === 0x79 && buffer[7] === 0x70) {
      return 'video/mp4';
    }
    return 'video/mp4';
  }
  if (buffer[0] === 0x00 && buffer[1] === 0x00 && buffer[2] === 0x00 && (buffer[3] === 0x14 || buffer[3] === 0x1C)) {
