...
function normalizeStorageKey(value: string): string {
  ...
  if (lowerKey.startsWith('https://') || lowerKey.startsWith('http://')) {
    try {
...
async function resolveStorageKey(
  ...
  const legacyKey = 'proofs/' + orderNumber + '/' + folder + '/' + fileName;
...
export async function GET(
  ...
  try {
    ...
    // التوجيه المباشر إلى الرابط الموقع
...
export async function DELETE(
  ...
  try {
    ...
    console.error('DELETE_ROUTE_FAILURE', {
